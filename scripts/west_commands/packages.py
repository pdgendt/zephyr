...
class Packages(WestCommand):
    ...
    def do_add_parser(self, parser_adder):
        ...
        pip_parser = subparsers_gen.add_parser(
            ...
            Manage pip packages:
                ...
                Run 'west packages pip' to print all pip packages and requirements
                files needed by Zephyr and modules.
    ...
    def do_run_pip(self, args, manager_args):
        ...
        for module in self.zephyr_modules:
            ...
            # Add individual listed packages
        ...
        if args.install:
            ...
            if len(packages) > 0 or len(requirements) > 0:
