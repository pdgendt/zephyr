...
/**
 * @file
 * @brief Public API for NFC ISO 14443 Type A
 */

#ifndef ZEPHYR_INCLUDE_NFC_ISO14443A_H_
#define ZEPHYR_INCLUDE_NFC_ISO14443A_H_
...
#define NFC_ISO14443_PCB_SBLOCK_MASK		0x30U
#define NFC_ISO14443_PCB_SBLOCK_WTX		0x30U
#define NFC_ISO14443_PCB_SBLOCK_DESELECT	0x00U

/**
 * @brief Maximum data length code for ISO/IEC 14443 A ATQA.
 */
#define NFC_ISO14443A_MAX_ATQA_LEN	2U
/**
 * @brief Maximum data length code for ISO/IEC 14443 A UID.
 */
#define NFC_ISO14443A_MAX_UID_LEN	10U
/**
 ...
 */
#define NFC_ISO14443A_MAX_HISTORY_LEN	249U

/**
 * @brief ATQA UID single size type (4 bytes).
 */
#define NFC_ISO14443A_ATQA_UID_SINGLE	0x0U
/**
 * @brief ATQA UID double size type (7 bytes).
 */
#define NFC_ISO14443A_ATQA_UID_DOUBLE	0x1U
/**
 * @brief ATQA UID triple size type (10 bytes).
 */
#define NFC_ISO14443A_ATQA_UID_TRIPLE	0x2U
 ...
 * @brief TODO
 */
#define NFC_ISO14443A_SAK_ATS_SUPPORTED	0x20U
...
struct nfc_iso14443a_info {
	uint8_t atqa[NFC_ISO14443A_MAX_ATQA_LEN];
	uint8_t uid[NFC_ISO14443A_MAX_UID_LEN];
	uint8_t uid_len;
	uint8_t sak;
	union {
		uint8_t fsci;
	...
	uint8_t sfgi;
	uint8_t fwi;
	uint8_t history[NFC_ISO14443A_MAX_HISTORY_LEN];
	uint8_t history_len;
	uint8_t block_num;
};
...
#endif /* ZEPHYR_INCLUDE_NFC_ISO14443A_H_ */
