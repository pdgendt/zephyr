...
if(NOT CODECHECKER_NAME)
  if(TWISTER_TESTSUITE_NAME AND TWISTER_TESTSUITE_PLATFORM)
    set(CODECHECKER_NAME "${TWISTER_TESTSUITE_PLATFORM}:${TWISTER_TESTSUITE_NAME}")
  else()
...
elseif(TWISTER_TESTPLAN_ZEPHYR_VERSION)
  set(CODECHECKER_STORE_TAG "--tag;${TWISTER_TESTPLAN_ZEPHYR_VERSION}")
endif()
